        ...
        filteredSearchTerm: function filteredSearchTerm() {
            ...
            if (!this.loading) {
                ...
                return this.processos.filter(function (item) {
                    return item.servidor.nome.indexOf(term) > -1 || item.servidor.siape == term || item.processo.indexOf(term) > -1;
                });
            }
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return (!_vm.loading) ? _c('div', {
      ...
      }, [_vm._v("\n                                    " + _vm._s(avaliador.tipo.toUpperCase()))])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(avaliador.nome.toUpperCase()))])])
